...
Q_CONSTINIT static const qt_meta_stringdata_CLASSQuesForTimeENDCLASS_t qt_meta_stringdata_CLASSQuesForTimeENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(55, 4),  // "page"
        QT_MOC_LITERAL(60, 10),  // "deleteTime"
        QT_MOC_LITERAL(71, 23),  // "on_choisTransPb_clicked"
        QT_MOC_LITERAL(95, 21),  // "on_transferPb_clicked"
        QT_MOC_LITERAL(117, 19)   // "on_deletePb_clicked"
    },
    "QuesForTime",
    "closeWnd",
    "",
...
void QuesForTime::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->transferToWork((*reinterpret_cast< std::add_pointer_t<FreeTime*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
