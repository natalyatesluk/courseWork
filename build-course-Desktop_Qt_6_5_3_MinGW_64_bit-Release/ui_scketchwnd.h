...
"            }"));
        ...
        widget = new QWidget(ScketchWnd);
        widget->setObjectName("widget");
        horizontalLayout = new QHBoxLayout(widget);
        horizontalLayout->setObjectName("horizontalLayout");
        deletePb = new QPushButton(widget);
        deletePb->setObjectName("deletePb");

        horizontalLayout->addWidget(deletePb);

        addPb = new QPushButton(widget);
    ...
    void retranslateUi(QWidget *ScketchWnd)
    {
        ...
        deletePb->setText(QCoreApplication::translate("ScketchWnd", "DELETE", nullptr));
