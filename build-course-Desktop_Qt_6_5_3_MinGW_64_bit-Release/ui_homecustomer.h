...
"            }"));
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/photo/free.png"), QSize(), QIcon::Normal, QIcon::Off);
        freePb->setIcon(icon3);
        freePb->setIconSize(QSize(35, 35));

        gridLayout->addWidget(freePb, 5, 1, 1, 1);

        exitPB = new QPushButton(welcomePage);
        exitPB->setObjectName("exitPB");
        exitPB->setStyleSheet(QString::fromUtf8("QPushButton\n"
"{\n"
...
"            }"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/photo/door.png"), QSize(), QIcon::Normal, QIcon::Off);
        exitPB->setIcon(icon4);
        exitPB->setIconSize(QSize(33, 33));

        gridLayout->addWidget(exitPB, 7, 1, 1, 1);
...
"            }"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/photo/homeicon.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        homePb->setIcon(icon5);
...
"            }"));
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/photo/back.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        backPb->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/photo/next.jpg"), QSize(), QIcon::Normal, QIcon::Off);
...
"            }"));
        ...
        homeCusStckW->setCurrentIndex(0);
    ...
    void retranslateUi(QWidget *HomeCustomer)
    {
        ...
        exitPB->setText(QCoreApplication::translate("HomeCustomer", "Exit", nullptr));
